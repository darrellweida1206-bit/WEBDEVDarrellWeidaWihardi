...
{
    if(isset($_REQUEST['dosen_NIDN']))
    {
        $dosen_NIDN = $_REQUEST['dosen_NIDN'];
    }
    if(empty($dosen_NIDN))
    {
...
{
    $query = mysqli_query($conn, "select * from dosen"); /* mengambil data dari tabel dosen */
}
/** end pencarian data */
?>
  ...
  <div class="row mb-3 mt-5">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="dosen_NIDN" name="dosen_NIDN" placeholder="Nomor Induk Dosen" maxlength="9" required="">
    </div>
  </div>
  <div class="row mb-3">
    <label for="dosen_NIK" class="col-sm-2 col-form-label">NIK Dosen</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="dosen_NIK" name="dosen_NIK" placeholder="Isikan NIK Dosen">
    </div>
  </div>
  <div class="row mb-3">
    <label for="dosen_Nama" class="col-sm-2 col-form-label">Nama Dosen</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="dosen_Nama" name="dosen_Nama" placeholder="Isikan Nama Dosen">
    </div>
  </div>
  <div class="row mb-3">
    <label for="dosen_Ket" class="col-sm-2 col-form-label">Keterangan Dosen</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="dosen_Ket" name="dosen_Ket" placeholder="Keterangan Dosen">
    </div>
  </div>
   ...
   <div class="col-1"></div>
    ...
    { ?>
        <tr class="danger"> 
            ...
            <td>
                <a href="hapusdsn.php?hapusdsn=<?php echo $row["dosen_NIDN"]?>" class="btn btn-danger" title="HAPUS" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
