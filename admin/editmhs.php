...
/*mengambil nilai baru dari formulir*/
if(isset($_POST['Ubah'])) 
{
    ...
    mysqli_query($conn, "UPDATE mahasiswa SET mhs_Nama = '$mhs_Nama', mhs_Alamat = '$mhs_Alamat', mhs_DOB = '$mhs_DOB', mhs_Ket = '$mhs_Ket' WHERE mhs_NPM = '$NPM'");
...
/** end pencarian data */
/**Menampilkan formulir yang sudah terisi dengan data mahasiswa yang akan diedit. */
?>
  <div class="row">
  <div class="col-1"></div>
  <div class="col-10">
  ...
  <div class="row mb-3 mt-5">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="npmMHS" name="npmMHS" value="<?php echo $row_edit['mhs_NPM']?>" readonly>
    </div>
  </div>
  <div class="row mb-3">
    <label for="namaMHS" class="col-sm-2 col-form-label">Nama Mahasiswa</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="namaMHS" name="namaMHS" value="<?php echo $row_edit['mhs_Nama']?>" placeholder="Isikan Nama Mahasiswa">
    </div>
  </div>
  <div class="row mb-3">
    <label for="alamatMHS" class="col-sm-2 col-form-label">Alamat Mahasiswa</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="alamatMHS" name="alamatMHS" value="<?php echo $row_edit['mhs_Alamat']?>" placeholder="Isikan Alamat Mahasiswa">
    </div>
  </div>
  <div class="row mb-3">
    <label for="lahirMHS" class="col-sm-2 col-form-label">Lahir Mahasiswa</label>
    <div class="col-sm-10">
      <input type="date" class="form-control" id="lahirMHS" name="lahirMHS" value="<?php echo $row_edit['mhs_DOB']?>" placeholder="Tanggal Lahir Mahasiswa">
    </div>
  </div>
  <div class="row mb-3">
    <label for="ketMHS" class="col-sm-2 col-form-label">Keterangan</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="ketMHS" name="ketMHS" value="<?php echo $row_edit['mhs_Ket']?>" placeholder="Keterangan Mahasiswa">
    </div>
  </div>
