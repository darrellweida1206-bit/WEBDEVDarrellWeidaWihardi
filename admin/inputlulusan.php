...
if(isset($_POST['Simpan'])) /* Mengecek apakah tombol simpan sudah di pilih/klik atau belum */
{
    ...
    mysqli_query($conn, "insert into lulusan values('$mhs_NPM', '$lulusan_IPK', '$lulusan_Predikat', '$lulusan_FOTO')"); /* memasukkan data ke dalam tabel */
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="decimal" class="form-control" id="lulusanIPK" name="lulusanIPK" placeholder="Contoh: 4.00" required="">
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
      <select class="form-control" id="lulusanPREDIKAT" name="lulusanPREDIKAT" required="">
        <option value="" disabled selected>Pilih Predikat Kelulusan</option>
